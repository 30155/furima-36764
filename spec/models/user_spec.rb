...
RSpec.describe User, type: :model do
  ...
  describe 'ユーザー新規登録' do
    ...
    context '新規登録できない場合' do
      ...
      it 'last_nameが全角のひらがな、カタカナ、漢字以外であれば登録できない' do
        @user.last_name = 'test'
        @user.valid?
      ...
      it 'first_nameが全角のひらがな、カタカナ、漢字以外であれば登録できない' do
      ...
      it 'last_name_kanaが全角のカタカタ以外であれば登録できない' do
      ...
      it 'first_nameが全角のカタカナ以外であれば登録できない' do
